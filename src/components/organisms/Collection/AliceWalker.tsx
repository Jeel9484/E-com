...
import aliceWalker from "@/data/Collection/CollectionData.json";

export default function AliceWalkerSection() {

  return (
    <section className="container-fluid mb-14">
      <div className="text-center mb-8">
        <h2 className="text-5xl mb-2.5">Alice Walker</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-14">
         {aliceWalker.aliceWalker.map((book, idx) => (
