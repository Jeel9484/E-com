...
export default function Header() {
  ...
  return (
    <header>
      {/* Topbar */}
      {/* <div className="w-full h-full flex justify-center gap-1 py-4 text-center bg-[#282828] text-base text-white">
      ...
      <div className="container-fluid flex justify-between items-center bg-white py-6 border-b border-gray-200 mb-10">
        ...
        <button className="ml-2 flex gap-4 md:hidden" onClick={() => setOpen(true)}>
